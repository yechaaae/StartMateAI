    ...
    async def _sections_from_announcement(
        ...
        *,
        ...
        try:
            ...
            profile_text = ""
        user_prompt = (
            "다음 지원사업 '공고문'에 맞춰 제출용 사업계획서 초안의 섹션을 작성하세요.\n"
            "- 공고의 모집대상, 지원내용, 평가/심사 관점, 일정 조건을 적극 반영하세요.\n"
            "- 창업 아이템과 창업자 프로필에 근거해 구체적이고 제출 가능한 수준으로 쓰세요.\n"
            "- 섹션은 5~6개. 각 섹션은 번호가 붙은 제목과 3~5문장 본문으로 구성합니다.\n"
            "- 반드시 JSON 배열만 출력하세요. 형식: "
            '[{"title": "1. 사업 개요", "body": "..."}, ...]. 코드펜스나 설명 문장은 넣지 마세요.\n\n'
            f"[창업 아이템] {idea_name}\n"
            f"[지원사업/공고 제목] {target}\n"
            f"[작성 목표 코드] {goal}\n"

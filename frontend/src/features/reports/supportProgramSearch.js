...
// 경북 사회적경제 창업학교 공고문(고정). plan 기능에서 이 공고로 진입하면
// 신청서의 '창업 아이템(사회적가치)'·'지원동기' 답변을 이 내용 기준으로 생성한다.
export const PINNED_GYEONGBUK_ANNOUNCEMENT = `[2026 경북형 사회적경제 창업학교] 참가자 모집

[주관] 경상북도 사회적경제지원센터 (대구대학교 산학협력단)
[지역] 경상북도 / [신청대상] 사회적경제에 관심 있는 대한민국 국민 누구나 (예비창업자·3년 미만 창업자 포함)
[접수기간] 2026.05.19 ~ 2026.06.14 23:59 (이메일/온라인 접수)
[교육일정] 2026. 6. 20.(토) ~ 7. 11.(토) 총 4회, 대구대학교 경산캠퍼스

[지원내용]
- 기본교육: 사회적경제 기초 및 창업 실무 교육 (총 20시간)
- 사업화 지원: 우수창업팀 대상 총 5천만원 규모 사업비 지원
- 기타: 창업공간 제공, 사회적경제기업 전환 컨설팅, 성장지원사업 연계 및 선배기업가 네트워킹
- 80% 이상 수강 시 기관 명의 수료증 발급 (사회적경제기업 인/지정 및 타지원사업 신청 시 활용 가능)
[선정평가] 별도 선정절차 없음 (사회적 가치와 실행 가능성을 갖춘 아이템을 우대)

[작성이 필요한 신청서 항목]
- 창업 아이템(사회적가치를 담아 간단하게 작성)
- 지원동기
`

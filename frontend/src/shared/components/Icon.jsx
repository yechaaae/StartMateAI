export const Icon = ({ name, size = 20, stroke = 1.8, className, style }) => {
  const paths = {
    ...
    coins: <><ellipse cx="9" cy="7" rx="5" ry="2.5" /><path d="M4 7v4c0 1.4 2.2 2.5 5 2.5s5-1.1 5-2.5V7" /><path d="M10 16.5c.8.6 2.3 1 4 1 2.8 0 5-1.1 5-2.5v-4" /><path d="M14 8.5c2.8 0 5 1.1 5 2.5s-2.2 2.5-5 2.5" /></>,
    ...
    scales: <><path d="M12 3v18M5 6h14M8 6 4.5 13h7L8 6ZM16 6l-3.5 7h7L16 6ZM8 18h8" /><path d="M4.5 13a3.5 3.5 0 0 0 7 0M12.5 13a3.5 3.5 0 0 0 7 0" /></>,
